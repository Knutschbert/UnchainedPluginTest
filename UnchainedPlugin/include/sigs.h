...
static const char* signatures[F_MaxFuncType + 1] =
{
	...
	/*LoadFrontEndMap*/
	"4C 89 4C 24 20 4C 89 44 24 18 48 89 4C 24 08 55 56 57 41 54 48 8D 6C 24 C1 48 81 EC D8 00 00 00 83 79 08 01 4C 8B E2 48 8B F9 7F 19 33 F6 48 8B C2 48 89 32 48 89 72 08 48 81 C4 D8 00 00 00 41 5C 5F 5E 5D C3 48 89 9C 24 08 01 00 00 48 8D 55 B7 4C 89 AC 24 D0 00 00 00 4C 89 B4 24 C8 00 00 00 4C 89 BC 24 C0 00 00 00 E8 ?? ?? ?? ?? 4C 8B 6D B7 48 8D 4D 97 33 F6 48 89 75 97 48 89 75 9F 49 8B 45 00 8D 56 11 48 8B 40 50 48 89 45 C7 E8 ?? ?? ?? ?? 8B 55 9F 8D 5A 11 89 5D 9F 3B 5D A3 7E 0C 48 8D 4D 97 E8 ?? ?? ?? ?? 8B 5D 9F 4C 8B 75 97 48 8D 15 ?? ?? ?? ?? 49 8B CE 41 B8 22 00 00 00 E8 ?? ?? ?? ?? 8B 4F 08 83 F9 01 7F 08 4D 8B FE 4C 8B F6 EB 60 85 DB 74 09 44 8D 7B FF 41 8B C7 EB 05 44 8B FE 8B C6 48 8B 5D 67 8D 14 08 48 8B F9 48 89 75 97 45 33 C0 89 7D 9F 48 8D 4D 97 48 8B 1B E8 ?? ?? ?? ?? 48 8B 4D 97 4C 8D 04 3F 48 8B D3 E8 ?? ?? ?? ?? 45 8B C7 48 8D 4D 97 49 8B D6 E8 ?? ?? ?? ?? 4C 8B 7D 97 8B 5D 9F 48 89 75 97 48 89 75 9F 48 89 75 87 8B D6 89 55 8F 8B CE 89 4D 93 85 DB 74 0A 49 8B FF 4D 85 FF 74 5A EB 07 48 8D 3D ?? ?? ?? ?? 66 39 37 74 4C 48 C7 C3 FF FF FF FF 48 FF C3 66 39 34 5F 75 F7 FF C3 85 DB 7E 11 8B D3 48 8D 4D 87 E8 ?? ?? ?? ?? 8B 4D 93 8B 55 8F 8D 04 13 89 45 8F 3B C1 7E 09 48 8D 4D 87 E8 ?? ?? ?? ?? 48 8B 4D 87 48 8B D7 4C 63 C3 4D 03 C0 E8 ?? ?? ?? ?? 48 8D 55 87 49 8B CD FF 55 ?? 48 8B 4D 87 48 85 C9 74 05 E8 ?? ?? ?? ?? 4D 85 FF 74 08 49 8B CF E8 ?? ?? ?? ?? 4D 85 F6 74 08 49 8B CE E8 ?? ?? ?? ?? 4C 8B 75 67 8B CE 49 83 C6 10 89 4D 97 45 8B 56 28 49 8D 7E 10 C7 45 9B 01 00 00 00 44 8B C6 48 89 7D 9F 41 BB 1F 00 00 00 C7 45 A7 FF FF FF FF 48 89 75 AB 45 85 D2 74 7A 48 8B 47 10 4C 8B CF 48 85 C0 4C 0F 45 C8 41 8D 42 FF 99 41 23 D3 8D 1C 02 41 8B 11 C1 FB 05 85 D2 75 2A 0F 1F 80 00 00 00 00 FF C1 41 83 C0 20 89 4D 97 44 89 45 AF 3B CB 7F 3B 48 63 C1 C7 45 A7 FF FF FF FF 41 8B 14 81 85 D2 74 DD 8B C2 F7 D8 23 C2 0F BD C8 89 45 9B 74 07 41 8B C3 2B C1 EB 05 B8 20 00 00 00 44 2B C0 41 8D 40 1F 89 45 AB 41 3B C2 7E 04 44 89 55 AB 41 8B 56 28 41 BD FF FF FF FF 0F 10 55 A7 8B CA 4C 89 75 FF 0F 10 45 97 41 23 CB 44 8B C2 0F 11 55 17 41 D3 E5 44 8B CA 0F 11 45 07 41 C1 F8 05 41 83 E1 E0 66 0F 15 D2 45 8B FA F2 0F 11 55 F7 44 89 6D A7 89 55 AB 0F 10 45 FF 0F 10 4D 0F 0F 11 45 D7 0F 11 4D E7 41 3B D2 74 6F 48 8B 47 10 4C 8B D7 48 85 C0 49 63 C8 4C 0F 45 D0 41 8D 47 FF 99 41 23 D3 8D 1C 02 41 8B 14 8A C1 FB 05 41 23 D5 75 1E 41 FF C0 41 83 C1 20 44 3B C3 7F 37 49 63 C0 C7 45 A7 FF FF FF FF 41 8B 14 82 85 D2 74 E2 8B C2 F7 D8 23 C2 0F BD C8 74 05 44 2B D9 EB 06 41 BB 20 00 00 00 45 2B CB 41 8D 41 1F 89 45 AB 41 3B C7 7E 04 44 89 7D AB 48 8B 5D A7 4C 8B BC 24 C0 00 00 00 4C 8B AC 24 D0 00 00 00 48 C1 EB 20 48 63 45 F3 48 8B 55 D7 3B C3 75 0B 48 39 7D E7 75 05 49 3B D6 74 2C 48 8D 0C 80 48 8B 02 48 8D 14 C8 48 8B 4D B7 4C 8D 42 10 48 8B 01 FF 50 ?? 8B 45 E3 48 8D 4D DF F7 D0 21 45 EF E8 ?? ?? ?? ?? EB BD 48 8B 4D 77 48 8D 55 B7 E8 ?? ?? ?? ?? 48 8B 4D B7 48 8B 01 FF 90 ?? ?? ?? ?? 4C 8B B4 24 C8 00 00 00 4C 8D 45 87 48 8B D8 48 8B CE 48 8B 45 7F 8B D6 48 89 4D 87 89 55 8F 49 3B C0 74 21 39 48 08 74 1C 4C 8B 00 4D 85 C0 74 14 49 8B 00 48 8D 55 87 49 8B C8 FF 50 ?? 8B 55 8F 48 8B 4D 87 48 89 75 C7 89 75 CF 85 D2 74 0F 48 85 C9 74 0A 48 8B 01 48 8D 55 C7 FF 50 ?? 48 8B 55 67 4C 8D 55 8F 49 3B C0 74 21 39 48 08 74 1C 4C 8B 00 4D 85 C0 74 14 49 8B 00 48 8D 55 87 49 8B C8 FF 50 ?? 8B 55 8F 48 8B 4D 87 48 89 75 C7 89 75 CF 85 D2 74 0F 48 85 C9 74 0A 48 8B 01 48 8D 55 C7 FF 50 ?? 48 8B 55 67 4C 8D 4D C7 4C 8D 05 ?? ?? ?? ?? 48 8D 4D 97 E8 ?? ?? ?? ?? 48 8B D0 48 8B CB E8 ?? ?? ?? ?? 39 75 9F 74 30 48 8B 4D 97 48 85 C9 74 38 48 8B 01 33 D2 FF 50 ?? 48 8B 45 97 48 85 C0 74 11 45 33 C0 33 D2 48 8B C8 E8 ?? ?? ?? ?? 48 89 45 97 89 75 9F EB 04 48 8B 45 97 48 85 C0 74 08 48 8B C8 E8 ?? ?? ?? ?? 8B 45 8F 48 8B 4D 87 85 C0 74 33 48 85 C9 75 09 85 C0 74 2A 48 85 C9 74 2F 48 8B 01 33 D2 FF 50 ?? 48 8B 4D 87 48 85 C9 74 11 45 33 C0 33 D2 E8 ?? ?? ?? ?? 48 8B C8 48 89 45 87 89 75 8F 48 85 C9 74 05 E8 ?? ?? ?? ?? 48 8B 4D B7 48 8B 01 FF 90 ?? ?? ?? ?? 48 8B 45 B7 49 89 04 24 48 8B 45 BF 49 89 44 24 08 48 85 C0 74 2E FF 40 08 48 8B 5D BF 48 85 DB 74 22 83 6B 08 01 75 1C 48 8B 03 48 8B CB FF 10 83 6B 0C 01 75 0E 48 8B 03 BA 01 00 00 00 48 8B CB FF 50 ?? 48 8B 9C 24 08 01 00 00 49 8B C4 48 81 C4 D8 00 00 00 41 5C 5F 5E 5D C3",
